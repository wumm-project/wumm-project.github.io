...
In the meantime we shortly discussed to apply for an
[European Industrial Doctorate](EID "wikilink") within the Marie Curie Action,
but this turned out to be far too ambitious, serious prospects of success are
hardly to be expected in that direction in view of the academic reputation of
TRIZ approaches. 

We have therefore agreed to return to the original approach and explore the
possibilities in the context of the Capacity Building Action.  The ERASMUS+
Key Action 2 Program "Capacity Building in the field of higher education"
concentrates on different consolidating aspects of higher education, hence is
rather directed towards academic teaching.  The current call is open since 05
Nov 2019.
...
The call is open since 05 Nov 2019, the deadline is 05 Febr 2020, so it is
very sportive to compile an application in the remaining time.

* All relevant problems are best to be discussed on our
  [mailing list](http://lists.informatik.uni-leipzig.de/mailman/listinfo/ttn).
* There will be an onsite meeting at INSA Strasbourg (Denis Cavallucci) on 14
  December 2019.
